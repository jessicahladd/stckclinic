...
class UsernamesControllerTest < ActionController::TestCase
  ...
  test "should create username" do
    assert_difference('Username.count') do
      post :create, username: { email: @username.email, password: @username.password, password_confirmation: @username.password_confirmation, username: @username.username }
    end
  ...
  test "should update username" do
    put :update, id: @username, username: { email: @username.email, password: @username.password, password_confirmation: @username.password_confirmation, username: @username.username }
    assert_redirected_to username_path(assigns(:username))
  end
